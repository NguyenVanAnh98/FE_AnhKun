...
export default function Tinhtien2() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/api/khachhang/sbo')
            .then(response => {
            ...
            .catch(error => {
                console.error('Error fetching SBO customers:', error);
                alert('Có lỗi xảy ra khi lấy danh sách khách hàng SBO: ' + error.message);
            });
    }, []);
    ...
    return (
        <Container>
            <Typography variant="h4" align="center" gutterBottom>Tính tiền SBO</Typography>
